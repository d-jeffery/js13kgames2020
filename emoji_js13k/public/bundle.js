...
var Card = function (_Component) {
  ...
  _createClass(Card, [{
    ...
    key: 'flip',
    value: function flip(socket, val) {
      var _this3 = this;

      socket.emit("flip", { "guess": val }, function (cardFace) {
    ...
    value: function render(props, state) {
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          'button',
          { 'class': 'front', onClick: this.flip.bind(this, props.socket, props.val), disabled: props.disabled },
          '?'
        ),
        (0, _preact.h)(
          'div',
  ...
  _createClass(Game, [{
    ...
    value: function bind() {
      ...
      this.socket.on("start", function (numOfCards) {
        ...
        _this2.setState({ started: true, cards: {
            player1: _this2.createHand(PLAYER_1),
            player2: _this2.createHand(PLAYER_2)
          } });
      });
    ...
    value: function render(props, state) {
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          'div',
          { 'class': 'grid' },
          this.state.cards.player1.map(function (index) {
            return index;
          })
        ),
        ...
        (0, _preact.h)(
          'div',
          { 'class': 'grid' },
          this.state.cards.player2.map(function (index) {
            return index;
          })
        ),
        (0, _preact.h)(
